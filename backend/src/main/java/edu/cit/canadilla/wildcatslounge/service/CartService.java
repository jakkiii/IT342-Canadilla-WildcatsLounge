...
import edu.cit.canadilla.wildcatslounge.dto.CartItemResponse;
...
public class CartService {
    ...
    @Transactional
    protected List<CartItem> getCartItems(Cart cart) {
    ...
    protected BigDecimal resolveUnitPrice(MenuItem menuItem, ServingType servingType) {
